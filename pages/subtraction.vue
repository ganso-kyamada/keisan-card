<template>
  <v-row>
    <v-col cols="12" class="text-center">
      ...
      <finished-card v-else calc-type="subtraction">
      </finished-card>
    ...
    <v-col cols="12" class="text-center">
      <answers-card :items="answers" calc-type="subtraction">
      </answers-card>
    </v-col>
  </v-row>
</template>
...
export default {
  ...
  computed: {
    ...
    question() {
      return this.subtractions[this.currentIndex]
    },
    isFinished() {
      return this.subtractions.length === this.answers.length
    }
  },
  methods: {
    answer(value) {
